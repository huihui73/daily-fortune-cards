...
function colorFromSeed(seed) {
  const colors = [
    { code: "#FF6B6B", name: "热情红" },
    { code: "#4ECDC4", name: "平静青" },
    { code: "#45B7D1", name: "智慧蓝" },
    { code: "#FFA07A", name: "温暖橙" },
    { code: "#98D8C8", name: "生机绿" },
    { code: "#F7DC6F", name: "快乐黄" },
    { code: "#BB8FCE", name: "神秘紫" },
    { code: "#85C1E9", name: "自由天蓝" },
    { code: "#F8C471", name: "活力金橙" }
  ];
